...
class Admin extends Person {
    ...
    public function getAllEnabledUsers() {
        $arr=array();
        $dbClass = new DBcontroller();
        $qry="select username,email,contact,status from usersInformation where role_id=2 and status=1";
        $result=$dbClass->runQry($qry);
    ...
    public function getAllDisableUsers() {
        $arr=array();
        $dbClass = new DBcontroller();
        $qry="select username,email,contact,status from usersInformation where role_id=2 and status=0";
        $result=$dbClass->runQry($qry);
